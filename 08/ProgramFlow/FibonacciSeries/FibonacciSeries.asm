...
//VMtranslator.Command.C_POP:pointer:1
@R4
D=A
@R13
M=D
...
//VMtranslator.Command.C_POP:that:0
@THAT
D=M
@0
D=D+A
...
//VMtranslator.Command.C_POP:that:1
@THAT
D=M
@1
D=D+A
...
0;JMP
($FibonacciSeries.vm.COMPUTE_ELEMENT)
//VMtranslator.Command.C_PUSH:that:0
@THAT
D=M
@0
A=D+A
...
//VMtranslator.Command.C_PUSH:that:1
@THAT
D=M
@1
A=D+A
...
//VMtranslator.Command.C_POP:that:2
@THAT
D=M
@2
D=D+A
...
A=M
M=D
//VMtranslator.Command.C_PUSH:pointer:1
@R4
D=A
D=M
@SP
